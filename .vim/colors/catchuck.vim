...
hi String		term=bold					ctermfg=166
hi Number   								ctermfg=172
hi Constant		term=underline				ctermfg=161				guifg=Cyan
hi Special		term=bold					ctermfg=33				guifg=Red
hi Identifier 	term=underline	cterm=bold	ctermfg=161 			guifg=#40ffff
hi Statement	term=bold					ctermfg=Yellow 			gui=bold	guifg=#aa4444
hi PreProc		term=underline				ctermfg=161		guifg=#ff80ff
hi Type			term=underline				ctermfg=LightGreen		guifg=#60ff60 gui=bold
hi Function		term=bold					ctermfg=40			guifg=White
hi Repeat		term=underline				ctermfg=161			guifg=white
hi Operator									ctermfg=161			guifg=Red
